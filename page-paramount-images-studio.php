...
<section>
	<div class="u-box">
		...
		<?php $projects = new WP_Query(array('orderby'=>rand, 'post_type'=>array('wedding', 'engagement'), 'meta_query'=> array(array('key'=>'pmt_album', 'value'=>'', 'compare'=> '!=')))); if ($projects->have_posts()): ?>
